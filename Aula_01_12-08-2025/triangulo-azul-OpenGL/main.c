...
// Função para desenhar um triângulo azul
...
void drawSquare() {
	...
	glBegin(GL_TRIANGLES);
	    ...
	    glVertex2i(320, 320); // Vértice superior esquerdo
...
void display() {
    ...
    // Chama a função para desenhar o triângulo azul
    drawSquare();
...
int main(int argc, char** argv) {
    ...
    // Cria uma janela com o título "Triângulo Azul"
    glutCreateWindow("Triângulo Azul");

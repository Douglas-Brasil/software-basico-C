...
// Função para desenhar um triângulo rosa

void drawSquare() {
    // Define a cor do triângulo como rosa
    glColor3f(1.0, 0.41, 0.71);

    // Desenha um quadrado usando GL_TRIANGLES (triângulo)
	glBegin(GL_TRIANGLES);
	    glVertex2i(320, 160); // Vértice inferior esquerdo
...
void display() {
    ...
    // Chama a função para desenhar o triângulo rosa
    drawSquare();
...
int main(int argc, char** argv) {
    ...
    // Cria uma janela com o título "Triângulo Rosa"
    glutCreateWindow("Triângulo Rosa");
